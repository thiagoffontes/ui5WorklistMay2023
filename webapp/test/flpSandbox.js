		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Categories",
									"targetURL": "#treinamentoappcategories-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"treinamentoappcategories-display": {
								"semanticObject": "treinamentoappcategories",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=treinamento.appcategories",
									"url": sap.ui.require.toUrl("treinamento/appcategories")
								}
							}
						}
					}
